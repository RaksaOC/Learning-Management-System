...
-- Viewing all teacher's assigned classrooms (teacher_id)
-- (Example query for teacher's data to be added here, if needed)
...
WHERE pa.status = 'inactive'  
  AND c.teacher_id = 'sample_teacher_id';
