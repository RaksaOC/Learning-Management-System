...
//    private VBox detailsVBox;
    ...
    private void initTableViewSql() {
        ...
        ObservableList<Map<String, String>> data = manageDepartmentManager.getAllDetailsSql();
...
//        ManageDepartmentManager manageDepartmentManager = new ManageDepartmentManager();
//        JSONArray all = manageDepartmentManager.getAllDetails();
//
...
//        specColumn.setCellValueFactory(cellData -> getJSONValue(cellData.getValue(), "specializations"));
//
//        // Set data to table
//        tableView.setItems(data);
//    }
