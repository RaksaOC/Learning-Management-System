package main.java.com.lms.controllers.layer3.groupEditControllers;
...
import main.java.com.lms.managers.layer3.edit_entity_manager.EditGroupManager;
...
public class EditGroupIDController extends MainFrameController {
    ...
    private void initialize() {
        ...
        idComboBox.setOnAction(event -> {
            manager = new EditGroupManager(idComboBox.getValue());
