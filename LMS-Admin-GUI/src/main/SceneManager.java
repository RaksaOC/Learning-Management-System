...
public class SceneManager extends Application {
    ...
    public void start(Stage stage) {
        primaryStage = stage;
        loadScene("loading", "resources/com/lmsAdmin/views/misc/LoadingScene.fxml");
    ...
    private static void loadScene(String name, String fxmlPath) {
        try {
    ...
    private static boolean loadScenes() {
